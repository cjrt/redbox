...
// --------------------------------------------------
// Internal state (was global in main.c)
// --------------------------------------------------
...
void input_set_camera(Camera* cam)
{
    camera = cam;
}
...
void input_update(GLFWwindow* win, float deltaTime,
